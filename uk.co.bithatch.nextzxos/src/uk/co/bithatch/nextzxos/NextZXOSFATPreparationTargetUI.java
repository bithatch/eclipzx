...
import static uk.co.bithatch.nextzxos.NextZXOSLaunchConfigurationAttributes.PREPARATION_BASE_ON_NEXT_ZXOS;
import static uk.co.bithatch.nextzxos.NextZXOSLaunchConfigurationAttributes.PREPARATION_RESET_IMAGE_STATE;
...
public class NextZXOSFATPreparationTargetUI implements IPreparationTargetUI {
	...
	public void initializeFrom(ILaunchConfiguration config) throws CoreException {
		...
		resetImageState.setSelection(config.getAttribute(PREPARATION_RESET_IMAGE_STATE, false));
	}
