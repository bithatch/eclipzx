...
public final class DezogZ80Thread extends DelegatingDebugElement implements IThread {
	
	
	private IStackFrame stackFrame;

	public DezogZ80Thread(IDebugTarget delegate) {
		super(delegate);
	...
	private IStackFrame updateStackFrame() {
		...
		return new DezogStackFrame(this, regs);
	}
}