...
public class ModeHandler extends AbstractSpriteHandler implements IElementUpdater {
				...
				if (editor instanceof AbstractSpriteEditor spriteEditor) {
					...
					if (file != null) {
						...
						element.setChecked(value != null && value.equals(EditorFileProperties
								.getProperty(file, EDITOR_MODE_PROPERTY, SpritePaintMode.SELECT.name()).toUpperCase()));
					}
				}
			}
		}
