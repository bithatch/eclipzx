...
public class PokeDialog extends Dialog {
	...
	protected void buttonPressed(int buttonId) {
    	...
    	pax.setPokeAddress(addressSpinner.getSelection());
    	pax.setPokeValue(valueSpinner.getSelection());
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        addressSpinner.setSelection(pax.getPokeValue());
        ...
        valueSpinner.setSelection(pax.getPokeValue());
