package uk.co.bithatch.eclipzoxo;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "uk.co.bithatch.eclipzoxo"; //$NON-NLS-1$
	...
	public static final String LARGE_ICON_PATH = "icons/zoxo128.png";
	...
	protected void initializeImageRegistry(ImageRegistry reg) {
		...
		reg.put(LARGE_ICON_PATH, imageDescriptorFromPlugin(PLUGIN_ID, LARGE_ICON_PATH));
	}
