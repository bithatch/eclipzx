...
public class OpenCodingPerspectiveAction implements IIntroAction {
    @Override
    public final void run(IIntroSite site, Properties params) {
    	ZXPerspectivesUI.switchToPerspective(ZXPerspectives.ZX_CODING_ID, PlatformUI.getWorkbench().getActiveWorkbenchWindow());
    }
