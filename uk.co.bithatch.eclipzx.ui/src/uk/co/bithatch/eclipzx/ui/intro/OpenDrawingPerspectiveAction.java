...
public class OpenDrawingPerspectiveAction implements IIntroAction {
    @Override
    public final void run(IIntroSite site, Properties params) {
    	ZXPerspectivesUI.switchToPerspective(ZXPerspectives.ZX_MEDIA_ID, PlatformUI.getWorkbench().getActiveWorkbenchWindow());
    }
