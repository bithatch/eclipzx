...
/**
 * Initially copied from Jdt, then copied from Xtext to here.
 * 
 * @author Michael Clay
 * @since 2.1
 */
public class ProjectSelectionDialog extends SelectionStatusDialog {
	...
	public ProjectSelectionDialog(Shell parentShell, Set<IProject> projectsWithSpecifics, IDialogSettings dialogSettings,  String filterText) {
		super(parentShell);
