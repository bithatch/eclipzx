...
public class ContributedSDKFieldEditor extends FieldEditor {

	private TableViewer viewer;
	private List<ZXSDK> allLibraries;

	public ContributedSDKFieldEditor(String name, String labelText, Composite parent) {
		init(name, labelText);
...
//		gd.minimumHeight = 130;
		...
		viewer.setLabelProvider(new SDKLabelProvider());
	...
	public void refresh() {
		allLibraries = ContributedSDKRegistry.getAllSDKs();
