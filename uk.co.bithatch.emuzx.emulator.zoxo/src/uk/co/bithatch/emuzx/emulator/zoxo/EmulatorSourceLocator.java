 ...
 */
public class EmulatorSourceLocator implements ISourceLocator, ISourcePresentation {

	private static final ILog LOG = ILog.of(EmulatorSourceLocator.class);

	@Override
	public Object getSourceElement(IStackFrame stackFrame) {
		if (stackFrame instanceof EmulatorZ80StackFrame gdbFrame) {
